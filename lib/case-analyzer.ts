...
5. المستندات الناقصة المطلوب طلبها (missingDocuments): مستندات لازمة لاستكمال مأمورية الخبرة وغير موجودة في الملف المرفوع (مثل كشوف الحساب البنكية، دفتر الأستاذ، الفواتير، سندات القبض والسداد، العقود والملاحق، كشوف الحساب بين الطرفين، القوائم المالية). لكل بند حدد: item (المستند المطلوب)، requestedFromPartyId (المطلوب من أي طرف من قائمة الأطراف المعطاة)، reason (سبب طلبه)، relatedTask (المهمة المرتبطة به من mandateTasks).
