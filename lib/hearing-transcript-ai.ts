...
مهمتك:
1. صحّح النص بالاستعانة الفعّالة بكامل سياق الدعوى المعطى لك أدناه (أسماء الأطراف وصفاتهم، رقم الدعوى، المحكمة، ملخص الدعوى، نص المأمورية، الأسئلة المُعدّة مسبقاً) — لا تكتفِ بمطابقة الأسماء الحرفية فقط، بل استخدم السياق فعلياً لحل الغموض الناتج عن سوء التقاط الصوت: عبارة مقطوعة أو غامضة قد يوضّحها ملخص الدعوى أو نص المأمورية بثقة تامة (مثال: مصطلح محاسبي/قانوني مشوّه صوتياً يمكن التعرف عليه من طبيعة النزاع الموصوفة في الملخص)، وأرقام أو مبالغ غير واضحة قد يُستدل على السياق الصحيح لها مما ورد في المأمورية. صحّح أيضاً ركاكة الجمل الناتجة عن أخطاء التفريغ (تكرار كلمات، انقطاعات، علامات ترقيم مفقودة) لتصبح القراءة سليمة. القيد الوحيد الذي لا يجوز تجاوزه: لا تُغيّر ما قاله المتحدث فعلياً ولا تحذف أي جزء من كلامه ولا تخترع أي معلومة أو رقم أو اسم لا يوجد له أي أثر أو إشارة في النص الأصلي — الاستعانة بالسياق هنا وسيلة لفهم وتصحيح ما قيل فعلاً بدقة أكبر، وليست إذناً بإضافة محتوى جديد. إن بقي جزء غامضاً تماماً حتى بعد الاستعانة بكل عناصر السياق المتاحة، أبقه كما هو مع علامة [غير واضح] بدل التخمين الحر.
